					...
					<div class="card-body">
						...
						<div class="form-row pt-2">
							...
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" id="pageName" v-model="pages.pageName">
							</div>
							...
							<div class="form-group col-md-6">
						    	<label for="pageUrl">Url</label>
						      	<div class="input-group mb-2 mb-sm-0">
						        	...
						        	<input type="text" class="form-control" id="pageUrl" v-model="pages.pageUrl">
						    	</div>
						    </div>
			...
			<ul class="list-group">
			  <li class="list-group-item" v-for="page in pages" :key="page.pageId">
					<ul class="nav">
					  ...
					  <li class="nav-item">
					    <a class="nav-link" v-bind:href="'pages?pageId=' + page.pageId + '&action=edit'" data-toggle="tooltip" data-placement="top" title="Edit Page"><i class="fa fa-fw fa-pencil-square-o"><span class="sr-only">Edit Page</span></i></a>
					  </li>
					  <li class="nav-item">
